...
export default function HomePage() {
  return (
    <>
      <Hero />
      <section id="products" className="container py-16 bg-white">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-fraunces font-bold text-black mb-4">Our Products</h2>
          ...
          <ul className="max-w-md mx-auto space-y-2 text-left text-neutral-700">
      ...
      <section className="py-16 bg-neutral-50">
        <div className="container">
          <h2 className="text-3xl font-fraunces font-bold text-center text-black mb-12">What Our Customers Say</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <article
                key={index}
                className="bg-white rounded-lg p-6 shadow-sm hover:-translate-y-2 transition-all duration-300 focus-visible:ring-2 ring-brand ring-offset-2"
                tabIndex={0}
              >
